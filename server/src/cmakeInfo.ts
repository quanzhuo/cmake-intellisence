...
export class CMakeInfo {
    ...
    public policies: Set<string> = new Set();
    public variables: Set<string> = new Set();
    public properties: Set<string> = new Set();
    ...
    public async init() {
        ...
        this.variables = expandedVariables;
...
export class ProjectInfoListener {
    ...
    constructor(
        ...
        this.commands = this.cmakeInfo.commands;
    ...
    private findPackage(ctx: FlatCommand): void {
        ...
        const projectInfoListener = new ProjectInfoListener(this.cmakeInfo, targetCMakeFile, this.baseDirectory, this.fileContexts, this.documents, this.parsedFiles, this.workspaceFolder, this.projectInfo);
